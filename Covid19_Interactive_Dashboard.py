...
df_states = pd.read_csv(
    "/Users/ferrigo/Downloads/Asimov Academy/Dashboard COVID-19/df_states.csv")
df_brasil = pd.read_csv(
    "/Users/ferrigo/Downloads/Asimov Academy/Dashboard COVID-19/df_brasil.csv")

token = open(
    "/Users/ferrigo/Downloads/Asimov Academy/Dashboard COVID-19/.mapbox_token").read()
brazil_states = json.load(open(
    "/Users/ferrigo/Downloads/Asimov Academy/Dashboard COVID-19/geojson/brazil_geo.json", "r"))
        ...
        dbc.Row([
            dbc.Col([
                    html.Div([
                        ...
                        #    "/Users/ferrigo/Documents/logo"), height=50),
                        html.H4(children="COVID-19 Evolution"),
                        dbc.Button("BRAZIL", color="primary",
                                   id="location-button", size="lg")
                    ], style={"background-color": "#1E1E1E", "margin": "-25px", "padding": "25px"}),
                    html.P("Enter the date on which you require information:", style={
                           "margin-top": "40px"}),
                    html.Div(
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([dbc.Card([
                                dbc.CardBody([
                                    ...
                                    html.Span("New cases on this date",
                                              className="card-text"),
                    ...
                    html.Div([
                        html.P("Select the type of data you are looking for:", style={
                               "margin-top": "25px"}),
                        dcc.Dropdown(
